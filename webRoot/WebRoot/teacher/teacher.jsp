		...
		<center>
			<div id="top"
				...
				<div
					...
					教师姓名：<%=session.getAttribute("name")%></div>
				<div
					style="font-size: 14px; width: 160px; height: 20px; float: left;"> 
					教师账号：<%=session.getAttribute("id")%></div>
				<!--nav,start-->
				<div class="menu_navcc">
					<div class="menu_nav clearfix">
						<ul class="nav_content">
							...
							<li>
								<a href="teacher/look_course.jsp" target="main">查看课程</a>
							
							</li>
							<li >
									<a href="teacher/create_course.jsp" target="main">创建课程</a>
							
							</li>
							<li >
									<a href="teacher/dele_course.jsp" target="main">删除课程</a>
